...
var RootCmd = &cobra.Command{
	Use:           "goaws",
	Short:         "Minimal AWS CLI written in Go.",
	SilenceErrors: true,
	SilenceUsage:  true,
}
...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default $HOME/.goaws.yml)")
...
func newClient() (*goaws.Client, error) {
	return goaws.NewClient(
		os.Stdin,
		os.Stdout,
		os.Stderr,
